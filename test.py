# Create a ready-to-deploy Vite + React + Tailwind project as a ZIP
...
<html lang="en">
  <head>
    ...
    <title>Universal Enhancement Simulator</title>
  </head>
...
/* small tweak for tooltip positioning on mobile */
...
readme = """\
# Universal Enhancement Simulator

A single-step upgrade simulator (+L → +(L+1)) with configurable stars, pity, and success rates.
